...
import sys
sys.path.append('/home/stellar/git/phyflow/backend')
...
from phyfleaux.fleaux import Task
# from phyfleaux.fleaux.context.tiramisu import Buffer, Constant, Expr, Function
# from phyfleaux.fleaux.context.tiramisu import Input, Var, Computation, View
...
class Polytope(ast.NodeVisitor):
    def __init__(self, task_: Task) -> None:
        """Task representation in the affine space.

        :arg task_: :class:`phyfleaux.fleaux.task.Task`
